    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_type', models.CharField(choices=[('Special Occasion', 'Special Occasion'), ('Other', 'Other'), ('Workshop', 'Workshop'), ('Wedding', 'Wedding'), ('Gala', 'Gala Event'), ('Corporate', 'Corporate Event')], max_length=20)),
