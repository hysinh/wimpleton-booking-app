...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Venue',
            fields=[
                ('venue_name', models.CharField(max_length=100, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_type', models.CharField(choices=[('OCC', 'Special Occasion'), ('WED', 'Wedding'), ('COR', 'Corporate Event'), ('GAL', 'Gala Event'), ('OTH', 'Other'), ('WSP', 'Workshop')], max_length=3)),
